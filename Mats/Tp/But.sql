Genere con SPOOL un script que selecciones todas las tablas del trabajo práctico (que comiencen con H_), y las mueva al tablespace BASEHOTELTP. Una vez generado el script, ejecútelo para mover efectivamente las tablas.
