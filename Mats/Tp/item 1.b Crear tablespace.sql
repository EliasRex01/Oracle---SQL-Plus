...
• CASCADE CONSTRAINTS: Elimina constraints de integridad referencial de las
tablas fuera d

Espacio de tabla TEMPORARY - Ejemplo
El siguiente ejemplo determina el directorio por default para la creación de 
los datafiles:
...
 Cambio de asignación de tablespace por defecto y tablespace temporal para el
usuario SYSTEM.
ALTER USER SYSTEM TEMPORARY TABLESPACE 
TEMPORARY_DATA;
