...
(
	...
	APLICAR_COBRO             VARCHAR2(1) NOT NULL ,  -- VALORES POSIBLES S, N, VALOR POR DEFECTO S
	CODIGO_FACTURA            NUMBER(15),
CONSTRAINT  PK_COD_CARGO PRIMARY KEY (CODIGO_CARGO)
);

CODIGO_CARGO     NUMBER(10)
GENERATED BY DEFAULT ON NULL AS IDENTITY (START WITH 1 INCREMENT BY 1 MAXVALUE 999)
NOT NULL
PRIMARY KEY,
