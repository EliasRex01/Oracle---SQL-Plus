...
-- La opción CASCADE CONSTRAINT elimina los constraints de integridad dependientes, No se puede realizar un rollback de esta sentencia
...
-- RENAME para cambiar el nombre de una tabla, vista, secuencia, o sinónimo
...
-- Para limpiar el comentario use el string que simboliza NULL (‘ ‘). Ejemplos:
SQL> COMMENT ON TABLE b_empleados IS 'Informacion del Empleado';
